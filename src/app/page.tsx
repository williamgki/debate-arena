    ...
    <main className="min-h-screen px-8 py-12 bg-gray-50 text-gray-900">
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <Link
            href="/setup?role=debater"
            className="block text-center px-6 py-4 bg-purple-600 text-white rounded-xl shadow hover:bg-purple-700 transition"
          >
            🎤 Be a Debater
          </Link>
          <Link
            href="/debates"
            className="block text-center px-6 py-4 bg-gray-100 border rounded-xl hover:bg-gray-200 transition"
          >
            👀 Watch Other Debates
          </Link>
        </div>
